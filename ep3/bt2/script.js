...
function submit_fnc_2(e,elm) {
   ...
   axios.get(`http://api.openweathermap.org/geo/1.0/direct?q=${input.value}&appid=418d123a8a610f690bbd1cdff706380b`)
   .then((data)=>{
       ...
       return axios.get(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=418d123a8a610f690bbd1cdff706380b&units=Metric`)
   }).then((data)=>{
       if (data != false) {
           const main = data.data.main
           document.querySelector("#humidity").innerHTML = main.humidity
